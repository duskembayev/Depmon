...
using Depmon.Server.Collector.ConfigBuilder.Actions;
using Depmon.Server.Collector.ConfigBuilder.Controls;
using Depmon.Server.Collector.ConfigBuilder.Exceptions;
...
namespace Depmon.Server.Collector.ConfigBuilder.ContextMenus
{
    class JTokenContextMenuStrip : ContextMenuStrip
    {
        ...
        protected ToolStripMenuItem TemplateToolStripItem;
        protected ToolStripItem InsertGroupToolStripItem;
        protected ToolStripItem InsertResourceToolStripItem;
        protected ToolStripItem InsertIndicatorToolStripItem;
        ...
        public JTokenContextMenuStrip()
        {
            ...
            //InsertResourceToolStripItem = new ToolStripMenuItem("Insert Resource", null, InsertGroup_Click);
            //InsertIndicatorToolStripItem= new ToolStripMenuItem("Insert Indicator", null, InsertGroup_Click);
